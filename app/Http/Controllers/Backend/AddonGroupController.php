...
{   
	...
	*/
	...
	public function index(){
		return view('backend.addon_groups.list');
	}
	...
	public function create(){
		...
		return view('backend.addon_groups.add',compact('addon_groups'));
	}
	...
	public function edit($id = null){
		...
		return view('backend.addon_groups.update',compact('addon_groups'));
	}
