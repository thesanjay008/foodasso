			...
			<div class="card-body">
					...
					<div class="form-row">
						...
						<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<input name="title_{{$lk}}" id="title_{{$lk}}" value="{{$data->translate('en')->title}}" placeholder="{{ trans('restaurants.title_'.$lk) }}" type="text" class="form-control">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <textarea class="form-control"  id="address_{{$lk}}" placeholder="1234 Main St" name="address:{{$lk}}"> {{$data->translate('en')->address}} </textarea>
              ...
              @endforeach
					...
					<div class="form-row">
	  				...
	  				<button class="mt-2 btn btn-primary">{{ trans('restaurants.update') }}</button>
				</form>
			</div>
		</div>
		<!-- CONTENT OVER -->
