				...
				<div class="form-row">
					<div class="col-md-2">
						<div class="position-relative form-group">
							...
							<input id="iso_code" type="text" value="{{$data->iso_code}}" class="form-control">
					...
					<div class="col-md-2">
						<div class="position-relative form-group">
							...
							<input id="calling_code" type="text" value="{{$data->calling_code}}" class="form-control">
				...
				<div class="form-row">
					<div class="col-md-2">
						<div class="position-relative form-group">
							...
							<input id="currency" type="text" value="{{$data->currency}}" class="form-control">
					...
					<div class="col-md-2">
						<div class="position-relative form-group">
							...
							<input id="currency_code" type="text" value="{{$data->currency_code}}" class="form-control">
					...
					<div class="col-md-2">
						<div class="position-relative form-group">
							...
							<input id="currency_symbol" name="currency_symbol" type="text" value="{{$data->currency_symbol}}" class="form-control">
