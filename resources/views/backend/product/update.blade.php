		...
		<div class="card-body">
			<form action="javascript:void(0);" onsubmit="saveProduct()" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="position-relative form-group">
							<label for="exampleFile">{{ trans('product.image') }}</label>
							...
							<div class="image-preview"><img id="image-src" src="@if($product->image) {{asset($product->image)}} @endif" width="100%"/></div>
						...
						<div class="position-relative form-group">
							<div>
								...
								<div class="custom-checkbox custom-control">
									<input type="checkbox" id="addons-{{$addon_group->id}}" class="custom-control-input" name="addons" value="{{$addon_group->id}}">
						...
						<div class="form-row">
							...
							<div class="col-md-5">
								<div class="input-group">
									 <input placeholder="Enter Price" step="1" type="number" class="form-control">
								</div>
							</div>
