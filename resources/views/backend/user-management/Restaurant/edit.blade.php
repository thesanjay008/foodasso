			...
			<div class="page-title-heading">
				<div>
					<div class="page-title-head center-elem">
						...
						<span class="d-inline-block">{{ trans('restaurant.edit') }}</span>
					</div>
				</div>
			</div>
				...
				<div class="page-title-subheading opacity-10">
					<nav class="" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="active breadcrumb-item" aria-current="page">{{ trans('restaurant.edit_restaurant') }}</li>
						</ol>
					</nav>
				</div>
			</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<input id="phone_number" type="text" class="form-control" value="{{$data->mobile_number}}" placeholder="{{ trans('common.placeholder.phone_number') }}">
							...
							<div class="col-md-12">
								Address:
								<input id="searchTextField" class="form-control" type="text" value="{{$userInfo->address}}" size="50" style="text-align: left;direction: ltr;">
								<div class="validation-div" id="val-address"></div>
								<br>
								<div class="row">
									<div class="col-md-6">
										Latitude:<input name="latitude" id="latitude" class="MapLat form-control" value="{{$userInfo->latitude}}" type="text" placeholder="Latitude"  disabled>
										<div class="validation-div" id="val-latitude"></div>
									</div>
									<div class="col-md-6">
										Longitude:<input name="longitude" id="longitude" class="MapLon form-control" value="{{$userInfo->longitude}}" type="text" placeholder="Longitude"  disabled>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="position-relative form-group">
									...
									<div class="image-preview"><img id="image-src" src="@if($data->profile_image) {{asset($data->profile_image)}} @endif" width="70%"/></div>
								</div>
							</div>
						</div>
					</div>
