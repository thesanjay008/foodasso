			...
			<div class="page-title-heading">
				<div>
					<div class="page-title-head center-elem">
						...
						<span class="d-inline-block">{{ trans('offers.add') }}</span>
					</div>
				</div>
			</div>
				...
				<div class="form-row">
					<div class="col-md-4">
						<div class="position-relative form-group">
							<label for="title" class="">{{ trans('offers.title') }}</label>
							<input type="text" id="title" placeholder="{{ trans('offers.placeholder.enter_title') }}" class="form-control">
				...
				<div class="form-row">
					<div class="col-md-4">
						<div class="position-relative form-group">
							...
							<input type="text" id="code" placeholder="{{ trans('offers.placeholder.enter_code') }}" class="form-control">
					...
					<div class="col-md-2">
						<div class="position-relative form-group">
							...
							<div class="input-group">
                                <input class="form-control" placeholder="{{trans('offers.placeholder.enter_discount')}}" name="discount" type="text" id="discount">
				...
				<div class="form-row">
						...
						<div class="form-row">
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<input type="text" id="start_date" placeholder="{{ trans('offers.placeholder.enter_start_date') }}" class="form-control" value="" autocomplete="off" data-toggle="datepicker">
							...
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<input type="text" id="end_date" placeholder="{{ trans('offers.placeholder.enter_end_date') }}" class="form-control" value="" autocomplete="off" data-toggle="datepicker">
					...
					<div class="col-md-6">
						<div class="form-row">
							<div class="col-md-12">
								<div class="position-relative form-group">
									<label for="exampleFile" class="">{{ trans('category.image') }}</label>
...
<script>
	...
	function saveCoupon(){
		...
		if(response.status == '200'){
			...
			setTimeout(function(){ window.location.href = "{{route('offers.index')}}"; }, 2000)
