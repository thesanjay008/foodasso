						...
						<div class="page-title-heading">
							<div>
								<div class="page-title-head center-elem">
									...
									<span class="d-inline-block">{{ trans('variation_group.update') }}</span>
								</div>
							</div>
						</div>
							...
							<div class="form-row">
								<div class="col-md-6">
									<div class="position-relative form-group">
										...
										<input type="text" id="title" placeholder="{{ trans('product.placeholder.title') }}" value="{{$data->translate('en')->title}}" class="form-control">
