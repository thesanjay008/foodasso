						...
						<div class="page-title-heading">
							<div>
								<div class="page-title-head center-elem">
									...
									<span class="d-inline-block">{{ trans('addon_group.add') }}</span>
								</div>
							</div>
						</div>
							...
							<div class="form-row">
								<div class="col-md-6">
									<div class="position-relative form-group">
										...
										<input type="text" id="title" placeholder="{{ trans('addon_group.placeholder.enter_group_name') }}" class="form-control">
								...
								<!-- <div class="col-md-2">
									<div class="position-relative form-group">
										<label for="addon_group_description" class="">{{ trans('addon_group.addon_group_description') }}</label>
										<input type="text" id="addon_group_description" placeholder="{{ trans('addon_group.placeholder.addon_group_description') }}" class="form-control">
...
<script>
  ...
  function saveAddonGroup(){
	...
	if(response.status == '200'){
			...
			setTimeout(function(){ location.href = '{{route("addon_groups.index")}}'; }, 2000)
